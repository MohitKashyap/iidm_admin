    ...
    render() {
        ...
        return (
            <div className="animated fadeIn">
                <Row>
                    <Col >
                        <h1 className="display-6 text-center"> Imperial Institutes of Designers</h1>
                        <p className="text-center">
                            (A Unit of Gaayatri Inspiration (OPC) Pvt Ltd)
                            </p>
                        <p className="text-center">A-9, 3rd Floor, Rajouri Garden </p>
                        <p className="text-center">New Delhi – 110021 </p>
                        <p className="text-center">Phone – 011-43510918, 41775472 </p>
                        <p className="text-center">Email – admission@imperialinstitutes.com </p>
                        <p className="text-center">GSTIN – 07AAHCG6847R1ZP </p>
                        <p className="text-center">Payment Receipt</p>
                    </Col>
                </Row>
                <Row>
                    <Col >
